var main = (function (exports) {
    ...
    ***************************************************************************** */
    ...
    const registerTrackedPropertyDefinition = (proto, name, initialValue) => {
    ...
    const getTrackedProperty = (obj, name) => {
    ...
    c.subscribe(() => console.log('c has changed'));
    ...
    exports.getTracked = getTracked;
    exports.getAllTrackedProperties = getAllTrackedProperties;
